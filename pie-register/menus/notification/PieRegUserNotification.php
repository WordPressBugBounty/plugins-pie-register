    ...
    <div class="notification-accordion">
      ...
      <div class="notification-item">
        ...
        <div class="content clearfix">
          <ul class="clearfix">
          <?php if($val == 'user_subscription_activated') { ?>
            <li class="<?php echo esc_attr($val)?> hide-div clearfix">
              <div class="fields">
                <label style="font-size:12px;margin-bottom:10px;font-size:14px;"><i><?php esc_html_e("Note: The email will be sent to the user immediately after the subscription has been activated.",'pie-register') ?></i></label>  
              </div>
            </li> 
          <?php } ?>
          <li class="<?php echo esc_attr($val)?> hide-div clearfix">
                  <div class="fields pie-email-notif-chkbox">
                    <label class="pie-enable-notif-chkbox-label" style="width:auto;margin-right:20px;"><?php esc_html_e("Enable",'pie-register');?></label>
            ...
            <li class="<?php echo esc_attr($val)?> hide-div clearfix">
                  <div class="fields pie-email-notif-radio">
              ...
              <div class="fields pie-email-notif-html-and-keys">
                  ...
                  <select class="piereg_replacement_keys" name="replacement_keys<?php echo esc_attr($val)?>" id="replacement_keys<?php echo esc_attr($val)?>">
                      ...
                      <optgroup label="<?php esc_attr_e("Other",'pie-register') ?>">
                          ...
                          <?php if($val == 'forgot_password_notification') { ?>
                          ...
                          <?php if($val == 'user_verification_rejected') { ?>
                            <option value="%verification_rejection_reason%"><?php esc_html_e("Reason for rejecting the user verification",'pie-register') ?></option>
                          <?php } ?>
                      </optgroup>
                  </select>
                  </p>
