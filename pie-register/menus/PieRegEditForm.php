...
?>
<div style="width:99%;overflow:hidden;" class="pieregister-admin piereg-manage-forms">
  <div class="right_section">
    <div class="pie_wrap">
      ...
      <form method="post" id="formeditor">
        ...
        <div class="piereg-manage-forms-top-btns-div" style="clear: both;float: none;">
          ...
          <div id="piereg-guide-link">
            <div id="piereg-guide-link-items">
                <div class="piereg-guide-link-icon" data-title="<?php esc_attr_e('Click here for a detailed guide.','pie-register');?>">
                    <a href="https://pieregister.com/documentation/how-to-choose-the-right-form-field-for-your-registration-forms/" target="_blank" rel="noopener noreferrer">
        ...
        <!--Form Settings End-->
        <fieldset class="piereg-field-settings">
    ...
    <div class="right_menu">
      ...
      <ul>
        <li id="standard_fields"><a class="right_menu_heading" href="javascript:;">
          ...
          <ul class="controls picker pie-content-ul"  id="content_2">
            ...
            <li><span style="margin-left:10px;">
              <?php esc_html_e("Certain fields have Field Visibility settings.","pie-register"); ?> <a style="font-size:12px;font-weight:0;padding:0;" target="_blank" href="https://pieregister.com/addons/field-visibility-addon/"> 
              <?php esc_html_e("Click here","pie-register"); ?></a> <?php esc_html_e("to view documentation.","pie-register"); ?>
              </span></li><br>
            <li><span style="margin-left:10px;">
              <?php esc_html_e("Certain fields have BbPress settings.","pie-register"); ?> <a style="font-size:12px;font-weight:0;padding:0;" target="_blank" href="https://pieregister.com/addons/bbpress-addon/"> 
              <?php esc_html_e("Click here","pie-register"); ?></a> <?php esc_html_e("to view documentation.","pie-register"); ?>
              </span></li>
          </ul>
        </li>
        ...
        <li id="default_fields"><a class="right_menu_heading" href="javascript:;">
          <?php esc_html_e("Legacy Fields","pie-register"); ?>
          </a>
