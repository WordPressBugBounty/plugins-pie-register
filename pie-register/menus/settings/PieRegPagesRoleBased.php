...
<div id="role_based_redirects">
	...
	<div class="settings piereg_added_area roles_container" style="padding-bottom:0px;margin-left:0px;">
		<fieldset class="piereg_fieldset_area" <?php disabled($_disable, true); ?>>
			...
			<legend><?php esc_html_e("Add Record", 'pie-register');
					echo wp_kses_post($_available_in_pro); ?></legend>
			...
			<form method="post" id="redirect_form">
				...
				<div class="fields" style="width:100%;">
					<div class="fields">
						...
						$pages	= wp_dropdown_pages(array(
							...
							"id"                    => "log_in_page",
							"name"                  => "log_in_page",
							"selected"              => esc_html($logged_in_page_id),
							"echo"                  => false
						));
						$url	= '<option value="0"';
					...
					<div class="fields <?php echo esc_attr(($logged_in_page_id == "0") ? "" : "hide"); ?>">
				...
				<div class="fields" style="width:100%;">
					<div class="fields">
						...
						<?php
						$pages2	= wp_dropdown_pages(array(
							"show_option_no_change" => "None",
							"id"                    => "log_out_page",
							"name"                  => "log_out_page",
							"selected"              => esc_html($log_out_page_id),
							"echo"                  => false
						));
						$url2	= '<option value="0"';
					...
					<div class="fields <?php echo esc_attr(($log_out_page_id == "0") ? "" : "hide"); ?>">
